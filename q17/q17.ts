...
//removing upto 2 memebers
while(count!=2) {
let var1=guestList.pop();
console.log(`${var1} soory you are not invited ! `);
count--;
}

for(let name1 of guestList){
    console.log(`${name1} you are still invited to dinner !`);
}
